"""Copied from https://github.com/autonomousvision/stylegan-xl/blob/main/pg_modules/blocks.py"""
...
try:
    ...
    from src.manipulator.style_gan_manipulator._internal.training.networks_stylegan2 import Conv2dLayer, Conv2dLayerDepthwise

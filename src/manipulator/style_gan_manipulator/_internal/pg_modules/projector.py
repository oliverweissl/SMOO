"""Copied from https://github.com/autonomousvision/stylegan-xl/blob/main/pg_modules/projector.py"""

import torch.nn as nn

try:
    from ..feature_networks.constants import (
        NORMALIZED_CLIP,
        NORMALIZED_IMAGENET,
    ...
    from src.manipulator.style_gan_manipulator._internal.feature_networks.vit import forward_vit
    from src.manipulator.style_gan_manipulator._internal.feature_networks.pretrained_builder import _make_pretrained
    from src.manipulator.style_gan_manipulator._internal.feature_networks.constants import (
        NORMALIZED_INCEPTION,
        NORMALIZED_IMAGENET,
        NORMALIZED_CLIP,
        VITS,
